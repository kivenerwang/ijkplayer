...
# add Component  -mxz
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libxvid"
...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-decoder=flash*"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-decoder=ms*"
